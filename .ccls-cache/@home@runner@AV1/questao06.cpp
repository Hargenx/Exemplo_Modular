/*6.	Escreva um programa que receba do usuário notas e faça a média dele dizendo se o aluno tenha sido aprovado ou não,
siga as regras da Estácio(AV1, AV2 e AV3), o programa deve ter pelo menos uma função e um procedimento. (2,0 pontos)*/
